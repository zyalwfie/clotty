...
if (isset($_POST['save'])) {
    $code_t = $_POST['code_t'];
    $brand = $_POST['brand'];
    $ctgry_code_t = $_POST['ctgry_code_t'];
    $size = $_POST['size'];
    $about = $_POST['about'];
    ...
    $sql = mysqli_query($con, "INSERT INTO trousers VALUES ('$code_t','$brand','$ctgry_code_t','$size','$about','$picture','$price')");
    if ($sql) {
...
<head>
    ...
    <title>Input Trousers Data</title>
</head>
...
<body>
    <div class="container mt-3">
        ...
        <h1 class="display-1 text-white text-center">Input Trousers Data</h1>
        ...
        <form class="w-50 mx-auto text-white" method="post" enctype="multipart/form-data">
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input id="code_t" type="text" class="form-control" name="code_t">
                </div>
                <div class="col-6">
            ...
            <div class="mb-3">
                ...
                <select id="ctgry_code_t" type="text" class="form-select" name="ctgry_code_t">
                    <?php
                    include("connect.php");
                    $sql = mysqli_query($con, "SELECT * FROM category_t ORDER BY kind");
                    ?>
                    <?php
                    while ($r = mysqli_fetch_array($sql)) {
                        echo "<option value=$r[ctgry_code_t]>$r[kind]</option>";
                    }
                    ?>
                </select>
            </div>
